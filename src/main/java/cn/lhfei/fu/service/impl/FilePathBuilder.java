...
public class FilePathBuilder implements IFilePathBuilder {
	...
	// ==========================================
	public String buildThesisFileName(ThesisBaseModel model, String studentName, int num) {
		String fileName = "";	//作业命名后完整名称
	...
	public String buildThesisFilePath(ThesisBaseModel model, String studentName) {
		String filePath = "";	//作业上传后存放路径
		String studentId = model.getStudentId(); // 学号
		//String academicYear = model.getAcademicYear(); // 学年
		String className = model.getClassName(); // 班级名称
	...
	public String buildThesisFullPath(ThesisBaseModel model, String studentName) throws NullPointerException {
		String absolutePath = "";
		String filePath = this.buildThesisFilePath(model, studentName);
		
		absolutePath = mkdirs(THESIS_ROOT_PATH +File.separator+ filePath);
	...
	private final String THESIS_ROOT_PATH = "thesis";
}
